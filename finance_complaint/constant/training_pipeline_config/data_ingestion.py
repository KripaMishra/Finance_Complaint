...
DATA_INGESTION_METADATA_FILE_NAME= "meta_infor.yaml"
DATA_INGESTION_MIN_START_DATE= "2011-12-01"
DATA_INGESTION_DATA_SOURCE_URL= f"f"https://www.consumerfinance.gov/data-research/consumer-complaints/search/api/v1/" \
