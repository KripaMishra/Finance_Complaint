...
class DataValidatoin(FinanceDataSchema):
    def __init__(self,
        ...
        try:
            ...
            self.data_validatoin_config= data_validatoin_config
    ...
    def read_data(self)->DataFrame:
        try:
            ...
            logger.info(f"DataFrame has been created using the file:{self.data_ingestion_artifact.feature_store_file_path}")
    ...
    def get_missing_report(dataframe:DataFrame)-> Dict[str, MissingReport]:
        try:
            ...
            logger.info(f"Preparing the missing report for each column")
            ...
            logger.info(f"Missing Report Completed: {missing_report}")
    ...
    def drop_unwanted_columns(self, dataframe:DataFrame)->DataFrame:
        try:
            ...
            rejected_dir= os.pat.join(self.data_validatoin_config.rejected_data_dir,"missing_data")
            os.makedirs(rejected_dir,exist_ok=True)
            file_path= os.path.join(rejected_dir, self.data_validatoin_config.file_name)
