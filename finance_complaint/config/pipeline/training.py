...
from finance_complaint.entity.config_entity import DataIngestionConfig, DataValidationConfig, DataTransformationConfig, ModelTrainerConfig, ModelEvaluationConfig, ModelPusherConfig, TrainingPipelineConfig
...
class FinanceConfig:
    ...
    def get_data_validation_config(self)->DataValidationConfig:
        ...
        try:
            ...
            accepted_data_dir= os.path.join(data_validation_dir, DATA_VALIDATOIN_ACCEPTED_DATA_DIR, self.timestamp)
